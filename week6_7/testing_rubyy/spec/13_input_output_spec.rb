...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      subject(:game_continue){ described_class.new(5, '10') }
  ...
  describe '#verify_input' do
    ...
    context 'when given invalid input as argument' do
      subject(:nil_input){described_class.new}
      it 'returns nil' do
        expect(nil_input.verify_input('12')).to be_nil
      end
    end
  end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      subject(:game_fourth){described_class.new(5, '5', 4)}
      it 'outputs correct phrase' do
        hard_phrase = "That was hard. It took you 4 guesses!\n"
        expect { game_fourth.final_message }.to output(hard_phrase).to_stdout
      end
    end
  end
end
