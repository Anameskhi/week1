...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    context "when the previuso step is 10 " do
    it "the answer will be 6"do
    previous_step = 10
  ...
  describe '#divide_by_two' do
    context "when the previus step is 18"do
      it "result will be 9" do
      previous_step = 18
      expect(game.divide_by_two(previous_step)).to eq(9)
      end
    end
  end
  ...
  describe '#subtract_random_number' do
    subject(:random_three){described_class.new(3)}
    context "when the random number is 3 and previuso number is 11" do
      it "the answer will be 8" do
        previous_step = 11
        expect(random_three.subtract_random_number(previous_step)).to eq(8)
      end
    end
  end
  ...
  describe '#play' do
    context 'when the random number is ...' do
      ...
      it 'will return 7' do
        expect(game_nineteen.play).to eq(7)
    ...
    context 'when the random number is ...' do
      subject(:game){described_class.new(2000)}
      it 'will return 7' do
    ...
    context 'when the random number is ...' do
      subject(:game){described_class.new(2102093000)}
      it 'will return 7' do
        expect(game.play).to eq(7)
      end
    end
