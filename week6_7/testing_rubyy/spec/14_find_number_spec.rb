...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 0 and max is 3' do
      subject(:game_guessing){described_class.new(0, 3)}
      it 'returns 1' do
    ...
    context 'when min and max both equal 3' do
      subject(:game_guessing){described_class.new(3, 3)}
      it 'returns 3' do
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      let(:game_over){double('random number',value:3)}
      subject(:game){described_class.new(0, 9, game_over, 3)}
    ...
    context 'when guess and random_number are not equal' do
      let(:game_over){double('random number',value:4)}
      subject(:game){described_class.new(0, 9, game_over, 3)}
